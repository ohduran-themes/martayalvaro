        ...
        <main className="mt-3 mb-32">
          ...
          <section>
            ...
            <article className="grid grid-cols-2 gap-1 mt-3 mx-3 h-64" style={{
              ...
              <p className="py-5 grid-row-start-2 col-span-2 text-center text-sm">Plaza Del Obispado, Santa Agnès de Malanyanes<br />La Roca del Vallès, Barcelona</p>
            </article>
          </section>
          ...
          <section className="mt-32">
            ...
            <article className="grid grid-cols-2 gap-1 mt-3 mx-3 h-64" style={{
              ...
              <p className="py-5 grid-row-start-2 col-span-2 text-center text-sm">Camí de la Casa Alta, s/n<br />Ctra. Granollers a Masnou, km.10<br />08410, Barcelona</p>
            </article>
          </section>
