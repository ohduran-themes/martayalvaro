  ...
  render(){
    ...
    return(
      <nav className="mx-1 mb-5 sm:mb-6 md:mb-8 mt-4 sm:mt-6">
        <ul className="flex justify-around md:justify-center px-2 text-center text-sm sm:text-base md:text-lg text-teal-800 font-semibold">
          <li><Link to="/" className="p-1 md:mx-5 rounded hover:bg-teal-800 hover:text-teal-100">Inicio</Link></li>
